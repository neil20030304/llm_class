"""
MMLU Evaluation Script using Ollama - Program 2 (Business Ethics)

This script evaluates Llama 3.2-1B on the MMLU benchmark using Ollama.
This program specifically evaluates the 'business_ethics' subject.
...
SUBJECT = "business_ethics"  # Single subject for this program
